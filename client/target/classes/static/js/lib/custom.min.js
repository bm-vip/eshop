function init_sidebar() {
    var e = function () {
        ...
        var e = $BODY.outerHeight(), a = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(),
            t = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(), n = e < t ? t : e;
...
function init_wysiwyg() {
    ...
    "undefined" != typeof $.fn.wysiwyg && (console.log("init_wysiwyg"), $(".editor-wrapper").each(function () {
        var a = $(this).attr("id");
        $(this).wysiwyg({toolbarSelector: '[data-target="#' + a + '"]', fileUploadError: e})
...
function init_cropper() {
    if ("undefined" != typeof $.fn.cropper) {
        ...
        var e = $("#image"), a = $("#download"), t = $("#dataX"), n = $("#dataY"), o = $("#dataHeight"),
            i = $("#dataWidth"), r = $("#dataRotate"), l = $("#dataScaleX"), s = $("#dataScaleY"), d = {
        ...
        $('[data-toggle="tooltip"]').tooltip(), e.on({
            ...
            var a, t, n = $(this), o = n.attr("name"), i = n.prop("type");
...
function init_knob() {
    if ("undefined" != typeof $.fn.knob) {
        ...
        var e, a = 0, t = 0, n = 0, o = $("div.idir"), i = $("div.ival"), r = function () {
    ...
    if (console.log("run_customtabs"), CustomTabs = function (e) {
        $(".tabbed_notifications > div").hide(), $(".tabbed_notifications > div:first-of-type").show(), $("#custom_notifications").removeClass("dsp_none"), $(".notifications a").click(function (e) {
            ...
            var a = $(this), t = "#" + a.parents(".notifications").data("tabbed_notifications"),
                n = a.closest("li").siblings().children("a"), o = a.attr("href");
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#canvasDoughnut").length) {
            var e = document.getElementById("canvasDoughnut"), a = {
        ...
        if ($("#canvasRadar").length) {
            var e = document.getElementById("canvasRadar"), a = {
        ...
        if ($("#polarArea").length) {
            var e = document.getElementById("polarArea"), a = {
                datasets: [{
                    data: [120, 50, 140, 180, 100],
                    backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
                    label: "My dataset"
...
function init_calendar() {
    if ("undefined" != typeof $.fn.fullCalendar) {
        ...
        var e, a, t = new Date, n = t.getDate(), o = t.getMonth(), i = t.getFullYear(),
            r = $("#calendar").fullCalendar({
                ...
                editable: !0,
                events: [{title: "تمام روز رویداد", start: new Date(i, o, 1)}, {
                    title: "رویداد طولانی",
                    start: new Date(i, o, n - 5),
                    end: new Date(i, o, n - 2)
                }, {title: "ملاقات", start: new Date(i, o, n, 10, 30), allDay: !1}, {
                    title: "نهار",
    ...
    if (console.log("run_datatables"), "undefined" != typeof $.fn.DataTable) {
        ...
        var e = {
            ...
            $("#datatable-buttons").length && $("#datatable-buttons").DataTable({
                language: e,
                dom: "Bfrtip",
                buttons: [{extend: "copy", text: "کپی", className: "btn-sm"}, {
                    extend: "csv",
                    text: "فایل CSV",
                    className: "btn-sm"
        ...
        TableManageButtons = function () {
        ...
        }(), $("#datatable").dataTable({language: e}), $("#datatable-keytable").DataTable({
            keys: !0,
            language: e
        }), $("#datatable-responsive").DataTable({language: e}), $("#datatable-scroller").DataTable({
            language: e,
            ...
            scrollCollapse: !0,
            scroller: !0
        }), $("#datatable-fixed-header").DataTable({language: e, fixedHeader: !0});
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        element: "graph_bar",
        data: [{device: "دیگر", geekbench: 1371}, {device: "آیفون 6S پلاس", geekbench: 1471}, {
            device: "آیفون 6S",
            geekbench: 2371
        }, {device: "آیفون 6 پلاس", geekbench: 1144}, {device: "آیفون 6", geekbench: 2154}, {
            device: "آیفون 5S",
            geekbench: 655
        }, {device: "آیفون 5", geekbench: 1571}, {device: "آیفون 3GS", geekbench: 275}, {
            device: "آیفون 4S",
            geekbench: 655
        ...
        element: "graph_donut",
        data: [{label: "مربا", value: 25}, {label: "یخ زده", value: 40}, {label: "فرنی", value: 25}, {
            label: "شکر",
            value: 10
        }],
    ...
    if ("undefined" != typeof echarts) {
        ...
        if ($("#mainb").length) {
            ...
            a.setOption({
                ...
                series: [{
                    ...
                    markPoint: {
                        data: [{name: "فروش‌ها", value: 182.2, xAxis: 7, yAxis: 183}, {
                            name: "خرید‌ها",
                            value: 2.3,
                            xAxis: 11,
                            yAxis: 3
        ...
        if ($("#echart_sonar").length) {
            ...
            t.setOption({
                ...
                toolbox: {
                    show: !0,
                    feature: {restore: {show: !0, title: "بازگردانی"}, saveAsImage: {show: !0, title: "ذخیره تصویر"}}
                },
                polar: [{
                    indicator: [{text: "فروش ها", max: 6e3}, {text: "مدیریت", max: 16e3}, {
                        text: "فناوری اطلاعات",
                        max: 3e4
                    }, {text: "پشتیبانی مشتری", max: 38e3}, {text: "توسعه", max: 52e3}, {text: "بازار یابی", max: 25e3}]
                }],
                calculable: !0,
                series: [{
                    ...
                    }, {value: [5e3, 14e3, 28e3, 31e3, 42e3, 21e3], name: "هزینه های واقعی"}]
                }]
            })
        }
        if ($("#echart_pyramid").length) {
            ...
            n.setOption({
                ...
                series: [{
                    ...
                    type: "funnel",
                    width: "40%",
                    data: [{value: 60, name: "چیزی #1"}, {value: 40, name: "چیزی #2"}, {
                        value: 20,
                        name: "چیزی #3"
                    }, {value: 80, name: "چیزی #4"}, {value: 100, name: "چیزی #5"}]
                }]
            })
        }
            ...
            i.setOption({
                ...
                toolbox: {
                    ...
                    feature: {
                        ...
                        }, restore: {show: !0, title: "بازگردانی"}, saveAsImage: {show: !0, title: "ذخیره تصویر"}
                    }
                },
                calculable: !0,
        ...
        if ($("#echart_scatter").length) {
            ...
            r.setOption({
                ...
                toolbox: {show: !0, feature: {saveAsImage: {show: !0, title: "ذخیره تصویر"}}},
        ...
        if ($("#echart_pie").length) {
            ...
            var c = {normal: {label: {show: !1}, labelLine: {show: !1}}}, u = {
        ...
        if ($("#echart_mini_pie").length) {
            ...
            m.setOption({
                ...
                series: [{
                    ...
                    radius: [105, 130],
                    itemStyle: c,
                    data: [{value: 68, name: "68%چیزی #1"}, {value: 32, name: "invisible", itemStyle: u}]
                }, {
                    name: "2",
                    type: "pie",
                    clockWise: !1,
                    radius: [80, 105],
                    itemStyle: c,
                    data: [{value: 29, name: "29%چیزی #2"}, {value: 71, name: "invisible", itemStyle: u}]
                }, {
                    name: "3",
                    type: "pie",
                    clockWise: !1,
                    radius: [25, 80],
                    itemStyle: c,
                    data: [{value: 3, name: "3%چیزی #3"}, {value: 97, name: "invisible", itemStyle: u}]
                }]
            })
        }
...
}(jQuery, "smartresize"), function (e, a) {
    var t = function (e, a, t) {
        var n;
        return function () {
            function o() {
