...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(honeypotFilter, UsernamePasswordAuthenticationFilter.class).authorizeRequests()
                ...
                .antMatchers("/ltr/**","/logout","/page_404","/page_403","/region_denied","/login","/registration","/about","/send-OTP","/api/v1/country/findAllSelect*","/api/v1/user/register*","/actuator/**").permitAll()
                ...
                .antMatchers(HttpMethod.PATCH, "api/v1/user").hasAnyRole(RoleType.name(RoleType.ADMIN),RoleType.name(RoleType.SUPER_WISER), RoleType.name(RoleType.USER))
