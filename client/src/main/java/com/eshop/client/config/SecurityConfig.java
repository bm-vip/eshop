...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/dashboard","/userManagement","/deposit","/arbitrage","/subscriptionPackage","/fileUpload/**","/api/v1/arbitrage/**","/subscription","/api/v1/user/**","/api/v1/role/**","/api/v1/wallet/**","/api/v1/parameter/**","/api/v1/subscription-package/**","/api/v1/subscription/**","/api/v1/files/**").hasAnyRole(RoleType.name(RoleType.ADMIN), RoleType.name(RoleType.SUPER_WISER), RoleType.name(RoleType.USER))
