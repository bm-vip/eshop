...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,  "/api/v1/files/**","/api/v1/common/**","/api/v1/files/**", "/api/v1/common/**","/api/v1/wallet/**","/api/v1/parameter/**","/subscriptionPackage","/api/v1/subscription-package/**","/dashboard","/deposit","/arbitrage","/api/v1/user/**","/api/v1/role/**").hasAnyRole(RoleType.name(RoleType.SUPER_WISER), RoleType.name(RoleType.USER))
                .antMatchers(HttpMethod.POST, "/api/v1/wallet/**").hasAnyRole(RoleType.name(RoleType.SUPER_WISER), RoleType.name(RoleType.USER))
