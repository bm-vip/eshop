...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(honeypotFilter, UsernamePasswordAuthenticationFilter.class).authorizeRequests()
                ...
                .antMatchers("/ltr/**","/logout","/page_404","/page_403","/region_denied","/login","/registration","/send-OTP","/api/v1/country/findAllSelect*","/api/v1/user/verify-email/**","/api/v1/user/register*","/actuator/**").permitAll()
