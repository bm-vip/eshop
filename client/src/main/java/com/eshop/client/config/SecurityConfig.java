...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,  "/dashboard","/deposit","/arbitrage","/api/v1/files/**", "/api/v1/common/**","/api/v1/wallet/**","/api/v1/parameter/**","/api/v1/subscription/**","/api/v1/subscription-package/**","/api/v1/user/**","/api/v1/role/**").hasAnyRole(RoleType.name(RoleType.SUPER_WISER), RoleType.name(RoleType.USER))
